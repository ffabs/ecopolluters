  ...
  render() {
    ...
    return (        
        ...
        <div className="footer">
          ...
          <div className="fb-share-button" data-href="https://ecopolluters.org/#/" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fecopolluters.org%2F%23%2F&amp;src=sdkpreparse" className="fb-xfbml-parse-ignore">SHARE ON FACEBOOK →</a></div>
          <div>
