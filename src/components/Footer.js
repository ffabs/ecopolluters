    ...
    return (        
        ...
        <div className="footer">
          ...
          <Modal open={open} onClose={this.onCloseModal} center>
            ...
            <h3>2. Hotjar</h3>
            <div>
              To improve your user experience on our internet pages we use software from Hotjar (http://www.hotjar.com, 3 Lyons Range, 20 Bisazza Street, Sliema SLM 1640, Malta, Europe). Using the software, we can measure and evaluate user behavior (mouse movements, clicks, keystrokes, scroll height, etc.) on our websites. For this purpose, cookies are placed on users’ terminals and data from users such as browser information, operating system, time spent on the page, etc. can be stored. You can find more information about the processing of data by Hotjar at http://www.hotjar.com/privacy. You can object to the use of Hotjar’s services at https://www.hotjar.com/opt-out.
            </div>
